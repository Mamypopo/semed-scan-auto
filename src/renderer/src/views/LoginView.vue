  ...
  <div class="max-w-sm mx-auto pt-6">
    <div class="card">
      ...
      <div class="text-center mb-6">
        <div class="w-12 h-12 mx-auto mb-3 rounded-2xl bg-[#9333ea] flex items-center justify-center text-white text-xl font-bold shadow-lg shadow-purple-200">
          S
        </div>
      ...
      <form @submit.prevent="handleLogin" class="space-y-3">
        <div>
          <label class="block text-xs font-medium text-zinc-600 mb-1.5">อีเมล</label>
          <input
            v-model="form.email"
            type="email"
            class="input"
            placeholder="name@semed.co.th"
            required
            autocomplete="email"
          />
        </div>
        ...
        <div>
          <label class="block text-xs font-medium text-zinc-600 mb-1.5">รหัสผ่าน</label>
          <div class="relative">
            <input
        ...
        <div class="flex items-center gap-2 pt-1">
          <input
            ...
            type="checkbox"
            id="rememberMe"
            class="w-3.5 h-3.5 rounded border-zinc-300 text-[#9333ea] focus:ring-purple-500/30 cursor-pointer"
          />
